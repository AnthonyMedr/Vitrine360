...
const fallbackStore: PublicStoreSettings = {
  ...
  openingHours: brandConfig.defaultStoreOpeningHours,
  instagramUrl: brandConfig.defaultInstagramUrl,
  facebookUrl: "",
  websiteUrl: "",
  institutionalText: brandConfig.defaultStoreInstitutionalText,
  primaryColor: "#1f2329",
